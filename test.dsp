...
note = hslider("Midi note",60,1,88,1) : si.smooth(ba.tau2pole(0.03));
...
lfoFreq = hslider("LFO Frequency",0,0.001,10,0.001) : si.smoo;
...
gen = osc1 * g1, osc2 * g2, osc3 * g3 :> ef.cubicnl(drive, 1) : fi.dcblocker : ve.moog_vcf_2b( filtRes, filtFreq );
test = gen <: _, _;
